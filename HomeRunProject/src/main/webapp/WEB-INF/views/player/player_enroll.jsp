        ...
        <div class="innerOuter">
            ...
            <form action="savePlayer.player" method="post">
                <div class="form-group" id="player-enroll-form">
                    ...
                    <input type="radio" id="pro" value="1" name="playerGrade">
                    <label for="Male">프로</label> &nbsp;&nbsp;
                    <input type="radio" id="amateur" value="2" name="playerGrade">
                    <label for="Female">아마추어</label> &nbsp;&nbsp;
                    <input type="radio" id="normal" value="3" name="playerGrade" checked>
                    ...
                    <input type="number" min="1000000" max="1000000000" step="1000000" name="playerSalary">                    
                    <br><br>
            
                    <label for="player-no">희망 등번호 : </label>
                    <input type="number" min="1" max="100" placeholder="1번부터 100번까지 입력가능" name="backNumber">  <!-- 입력창 길이 늘리는법 모르게씀 cols="70" rows="10" size="40" -->                  
                </div>
                <br>
